...
--
-- Table structure for table `T_BOOK_IN_RECORD`
--
...
CREATE TABLE `T_BOOK_IN_RECORD` (
  ...
  `T_IN_RECORD_ID_FK` int(11) NOT NULL,
...
--
-- Dumping data for table `T_BOOK_IN_RECORD`
--

LOCK TABLES `T_BOOK_IN_RECORD` WRITE;
/*!40000 ALTER TABLE `T_BOOK_IN_RECORD` DISABLE KEYS */;
/*!40000 ALTER TABLE `T_BOOK_IN_RECORD` ENABLE KEYS */;
UNLOCK TABLES;
